...
const D: Dict = {
  ...
  "onb.start": { en: "Start protecting", sr: "Počni zaštitu" },
  ...
  "live.modeOne": { en: "One at a time", sr: "Jedna po jedna" },
  "live.modeAll": { en: "Show all", sr: "Sve odjednom" },
  "live.showingTop": { en: "showing the most dangerous", sr: "prikazana najopasnija" },
  "live.short": { en: "Live", sr: "Uživo" },
  "food.short": { en: "Food", sr: "Hrana" },
  ...
  "space.title": { en: "The whole room", sr: "Cela prostorija" },
  "space.needMore": {
    en: "One photo shows one wall. Photograph this room from another side too — the danger is often the route, not the object: a chair by the worktop by the hob is a way up to boiling water.",
    sr: "Jedna slika pokazuje jedan zid. Snimite ovu prostoriju i sa druge strane — opasnost je često put, a ne predmet: stolica uz radnu ploču uz šporet je put do ključale vode.",
  },
  "space.another": { en: "Photograph another angle", sr: "Snimi još jedan ugao" },
  "space.ready1": { en: "You have", sr: "Imate" },
  "space.ready2": { en: "angles of this room.", sr: "ugla ove prostorije." },
  "space.assess": { en: "Assess the whole room", sr: "Proceni celu prostoriju" },
  "space.working": { en: "Thinking about the room…", sr: "Razmišljam o prostoriji…" },
  "space.failed": {
    en: "The whole-room assessment is not available right now. Your individual findings are unaffected.",
    sr: "Procena cele prostorije trenutno nije dostupna. Pojedinačni nalazi time nisu dirnuti.",
  },
  "space.routes": { en: "Routes the child can take", sr: "Putevi kojima dete može" },
